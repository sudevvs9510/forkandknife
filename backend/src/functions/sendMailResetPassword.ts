...
const reset_PasswordMailer = async (email: string, userId: string): Promise<{ success: boolean }> => {
   ...
   const mailOptions: nodemailer.SendMailOptions = {
      ...
      html: `<p>Dear user,</p>
            ...
            <button style="background-color : blue; width:150px; height : 50px; border-radius: 12px; cursor: pointer; border:none;"><a href=${process.env.ORIGIN}'/reset-password/${userId}' style="text-decoration: none; color: #ffffff; font-size: 16px; font-family: sans-serif; font-weight: 600;">Reset password</a></button>

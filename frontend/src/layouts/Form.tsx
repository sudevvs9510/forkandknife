...
const Form = () => {
  ...
  return (
    <>
      <button
        onClick={toggleModal}
        className="text-white bg-[#00655B] hover:bg-[#00655B] focus:outline-none focus:ring-4 focus:ring-[#00655B] font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:focus:ring-[#00655B]-900"
        type="button"
      >

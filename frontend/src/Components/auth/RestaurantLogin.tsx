...
const RestaurantLoginForm: React.FC = () => {
   ...
   const formik = useFormik<ResturantType>({
      initialValues: {
         email: "",
         password: ""
      },
      validate: validateLogin,
      onSubmit: async (values: ResturantType) => {
         console.log(values);
         try {
            const response = await RestaurantLoginApi(values);
         ...
         <div className="w-full bg-white shadow sm:rounded-lg flex h-full justify-center flex-1">
            <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
               ...
               <div className="mt-12 flex flex-col items-center">
                  <p className='text-2xl font-bold mb-3 text-[#00655B]'>Restaurant Login</p>
                     ...
                     <div className="mx-auto max-w-xs">
                        ...
                        <div className="flex flex-col items-center mt-5">
                           <div className="flex flex-col items-center">
                              <p className="mt-4">
                                 Don't have an account? <Link to="/restaurant/signup" className="text-green-700 hover:text-green-500">Signup</Link>
                              </p>
                           </div>
                        </div>
                     </div>
